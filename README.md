...
cd Scripts # Navigate to the repository & excute the files 
bash awscli.sh
bash docker.sh
bash eksctl.sh
bash helm.sh
...
[[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/KastroVKiran/Book-My-Show.git)](https://github.com/shani877/BMS.git)
